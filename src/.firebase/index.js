...
export { getFirestore, setDoc, getDoc, addDoc, doc, collection, getDocs, onSnapshot, deleteDoc } from 'https://www.gstatic.com/firebasejs/9.6.9/firebase-firestore.js';

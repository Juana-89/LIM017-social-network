...
export const login = () => {
    ...
    <input type="email" id="inp_email" class="form_inp" placeholder="Correo electrónico" ="" required/>
    <input type="password" id="inp_password" class="form_inp" placeholder="Contraseña" ="" required/>

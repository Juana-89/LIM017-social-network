...
export const forgot = () => {
  ...
  divForgotPassword.innerHTML = `<form id="form_forgot" class="form_forgot_password animated fadeInUp">
  ...
  divForgotPassword.querySelector('#form_forgot').addEventListener('submit', (e) => {
    e.preventDefault();
